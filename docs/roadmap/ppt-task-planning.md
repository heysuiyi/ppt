...
- [事实阶段推断](../../src/main/agent/runtime/prompts/prompt-stage.ts)
- [当前 Skill 排序](../../src/main/agent/runtime/prompts/skill-stage-policy.ts)
- [Skill 类型与加载层次](../../src/main/agent/skills/skill-types.ts)
- [Query 状态](../../src/main/agent/runtime/query/query-types.ts)
- [业务声明入口](../../src/main/agent/tools/core/begin-ppt-capability.ts)
- [锁文件契约](../../src/main/agent/tools/core/svg-deck-locks.ts)
- [页面与预览依赖](../../src/main/agent/tools/core/svg-deck-lifecycle.ts)
- [预览工具](../../src/main/agent/tools/core/preview-svg-page.ts)
- [提交工具](../../src/main/agent/tools/core/submit-svg-deck.ts)
